...
const Home: React.FC = () => {
  const scrollToParticipation = () => {
    ...
    if (participation) {
      participation.scrollIntoView({ behavior: "smooth" });
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          BE Computer Engineering student with a passion for filmmaking,
          directing, and visual storytelling. Creating narratives that connect,
